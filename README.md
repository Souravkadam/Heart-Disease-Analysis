...
http://127.0.0.1:5000
💡 Key Insights
Males aged 55–74 show the highest heart disease rates in the dataset
Diabetic patients have significantly elevated stroke risk
Even patients with Good self-rated health developed heart disease
Physical activity strongly correlates with lower heart disease risk — 71.8% of patients are active
Smoking, even without alcohol, is a strong independent risk factor
📅 Project Planning
...
🏫 Institution
D Y Patil Agriculture & Technical University, Talsande MCA Sandwich Program

📄 License
This project is submitted as part of an academic program. Dataset sourced from Kaggle — for educational purposes only.
